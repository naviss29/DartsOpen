      ...
      <div className="pt-1">
        ...
        {incident.type === "RESULT_DISPUTED" && (
          <Link
            ...
            className="inline-block rounded-lg border border-amber-400 px-3 py-2 text-xs font-semibold text-amber-700 hover:bg-amber-100"
          >
            Arbitrer ce match →
          </Link>
        )}
        ...
        {incident.type === "OTHER" && (
          <button
            ...
            className="rounded-lg border border-amber-400 px-3 py-2 text-xs font-semibold text-amber-700 hover:bg-amber-100 disabled:opacity-60"
          >
