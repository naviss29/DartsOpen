  ...
  if (!expanded) {
    return (
      <button
        ...
        className="rounded-lg border border-danger-border px-3 py-2 text-xs font-semibold text-danger hover:bg-danger-subtle"
      >
        Déclarer un forfait
      </button>
    );
    ...
    <div className="flex flex-col gap-2">
      ...
      <div className="flex flex-col gap-2 sm:flex-row">
        <button
          ...
          className="rounded-lg border border-danger-border px-3 py-2 text-xs font-semibold text-danger hover:bg-danger-subtle disabled:opacity-60"
        >
          {player1Name} forfait
        </button>
        <button
